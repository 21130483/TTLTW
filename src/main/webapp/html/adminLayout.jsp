<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/adminLayout.css?v=<%= System.currentTimeMillis() %>">
        <!-- Common CSS for features -->
        <link rel="stylesheet" href="../css/managerBills.css?v=<%= System.currentTimeMillis() %>">
        <link rel="stylesheet" href="../css/managerUsers.css?v=<%= System.currentTimeMillis() %>">
        <link rel="stylesheet" href="../css/managerProducts.css?v=<%= System.currentTimeMillis() %>">
        <link rel="stylesheet" href="../css/managerVouchers.css?v=<%= System.currentTimeMillis() %>">
        <link rel="stylesheet" href="../css/managerInventory.css?v=<%= System.currentTimeMillis() %>">
        <link rel="stylesheet" href="../css/statistics.css?v=<%= System.currentTimeMillis() %>">
    ...
    <body>
        <div class="noi-dung">
            ...
            <!-- Main Content -->
            <div id="main-content">
                <% String contentPage=(String) request.getAttribute("contentPage"); if (contentPage !=null) { %>
