            ...
            <%@ page import="dao.StatisticsDAO.ProductStat" %>
                <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                    <% List<RevenueStat> dailyRevenue = (List<RevenueStat>) request.getAttribute("dailyRevenue");
                            List<RevenueStat> monthlyRevenue = (List<RevenueStat>)
                                    request.getAttribute("monthlyRevenue");
                                    List<RevenueStat> yearlyRevenue = (List<RevenueStat>)
                                            request.getAttribute("yearlyRevenue");
                                            ...
                                            List<NewCustomerStat> dailyNewCustomers = (List<NewCustomerStat>)
                                                    request.getAttribute("dailyNewCustomers");
                                                    List<NewCustomerStat> monthlyNewCustomers = (List<NewCustomerStat>)
                                                            request.getAttribute("monthlyNewCustomers");
                                                            List<NewCustomerStat> yearlyNewCustomers = (List
                                                                <NewCustomerStat>)
                                                                    request.getAttribute("yearlyNewCustomers");

                                                                    List<ProductStat> topProducts = (List<ProductStat>)
                                                                            request.getAttribute("topProducts");
                                                                            ...
                                                                            <div class="quan-ly">
                                                                                <h1 class="title-stat">Thống kê hoạt
                                                                                    động kinh doanh</h1>

                                                                                <div class="kpi-container">
                                                                                    <div class="kpi-card revenue">
                                                                                        <span class="kpi-title">Tổng
                                                                                            Doanh thu</span>
                                                                                    ...
                                                                                    <div class="kpi-card">
                                                                                        <span class="kpi-title">Đơn hàng
                                                                                            trung bình (AOV)</span>
                                                                                        <span class="kpi-value">
                                                                                            <%= df.format(avgOrderValue)
                                                                                                %> Đồng
                                                                                        </span>
                                                                                    </div>
                                                                                ...
                                                                                <div class="stat-tabs">
                                                                                    <button class="tab-btn active"
                                                                                        onclick="switchTab('daily')">Theo
                                                                                        Ngày</button>
                                                                                    <button class="tab-btn"
                                                                                        onclick="switchTab('monthly')">Theo
                                                                                        Tháng</button>
                                                                                    <button class="tab-btn"
                                                                                        onclick="switchTab('yearly')">Theo
                                                                                        Năm</button>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="charts-grid">
                                                                                        <div class="chart-box">
                                                                                            <h3 class="chart-title">
                                                                                                Doanh thu theo ngày</h3>
                                                                                            <canvas
                                                                                                id="dailyRevenueChart"></canvas>
                                                                                        </div>
                                                                                        <div class="chart-box">
                                                                                            <h3 class="chart-title">
                                                                                            ...
                                                                                            <canvas
                                                                                                id="dailyCustomerChart"></canvas>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="table-box">
                                                                                        <h3 class="table-title">Chi tiết
                                                                                    ...
                                                                                    <div class="charts-grid">
                                                                                        ...
                                                                                        <div class="chart-box">
                                                                                            <h3 class="chart-title">
                                                                                                ...
                                                                                                tháng</h3>
                                                                                            <canvas
                                                                                                id="monthlyCustomerChart"></canvas>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="table-box">
                                                                                        <h3 class="table-title">Chi tiết
                                                                                ...
                                                                                <div id="yearlyTab" class="tab-content">
                                                                                    <div class="charts-grid">
                                                                                        <div class="chart-box">
                                                                                            <h3 class="chart-title">
                                                                                                Doanh thu theo năm</h3>
                                                                                            <canvas
                                                                                                id="yearlyRevenueChart"></canvas>
                                                                                        </div>
                                                                                        <div class="chart-box">
                                                                                            <h3 class="chart-title">
                                                                                ...
                                                                                <div class="table-box">
                                                                                    <h3 class="table-title">Bảng chi
                                                                                        tiết top sản phẩm bán chạy</h3>
                                                                                    <table class="stat-table">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                <th>Mã SP</th>
